...
import com.ben.smartcv.user.infrastructure.repository.IAuthorizationRepository;
...
@Service
public class AuthorizationUseCase implements OAuth2AuthorizationService {
	...
	public AuthorizationUseCase(IAuthorizationRepository authorizationRepository,
								RegisteredClientRepository registeredClientRepository) {
		this.authorizationRepository = authorizationRepository;
		this.registeredClientRepository = registeredClientRepository;

		ClassLoader classLoader = AuthorizationUseCase.class.getClassLoader();
	...
	private OAuth2Authorization toObject(Authorization entity) {
		...
		if (registeredClient == null) {
			log.error("RegisteredClient with id '{}' was not found in database.", entity.getRegisteredClientId());
			throw new DataRetrievalFailureException(
					"The RegisteredClient with id '" + entity.getRegisteredClientId() + "' was not found database.");
		}
