package com.ben.smartcv.user.infrastructure.repository.impl;
...
import com.ben.smartcv.user.infrastructure.repository.IClientRepository;
...
public class CustomRegisteredClientRepository implements RegisteredClientRepository {
	...
	public CustomRegisteredClientRepository(IClientRepository IClientRepository) {
	...
	public void save(RegisteredClient registeredClient) {
		...
		this.IClientRepository.save(toEntity(registeredClient));
	}

	@Override
	public RegisteredClient findById(String id) {
		Assert.hasText(id, "id cannot be empty");
		return this.IClientRepository.findById(id).map(this::toObject).orElse(null);
	}

	@Override
	public RegisteredClient findByClientId(String clientId) {
		Assert.hasText(clientId, "clientId cannot be empty");
		return this.IClientRepository.findByClientId(clientId).map(this::toObject).orElse(null);
	}
